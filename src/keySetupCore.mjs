...
/** Most env vars accepted in one save. The registry defines the supported provider credentials. */
...
export const KEY_SETUP_KEYS = Object.freeze([
  ...
  Object.freeze({
    id: 'tdx',
    title: 'TAIWAN TDX',
    unlocks: 'Taiwan live traffic cameras — freeways, highways and major cities',
    getUrl: 'https://tdx.transportdata.tw/',
